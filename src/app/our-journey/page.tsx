        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto max-w-3xl space-y-2">
            ...
            <p className="text-muted-foreground md:text-xl/relaxed">
              ...
              educational path at Benaiah Academy.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="max-w-2xl mx-auto text-muted-foreground md:text-lg">
              Discover the vibrant extracurricular activities that enrich our
      ...
      <section id="academic-journey" className="bg-card">
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="max-w-2xl mx-auto text-muted-foreground md:text-lg">
              Follow our students' learning path from foundational skills to
      ...
      <section id="graduations">
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="max-w-2xl mx-auto text-muted-foreground md:text-lg">
              Celebrating our students' achievements as they prepare for their
